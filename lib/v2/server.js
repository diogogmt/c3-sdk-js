module.exports =  [
  ...
  { name: 'destroyServer', uri: '​/servers/:id', uriParams: ['id'], service: '', type:'', method: 'delete', resKey: 'server' },
  ...
  { name: 'serverCalculateCru', uri: '​/servers/calculate/cru', uriParams: [], service: '', type:'', method: 'put', resKey: 'server' },
