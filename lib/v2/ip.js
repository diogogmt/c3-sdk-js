module.exports =  [
  ...
  { name: 'createIpActivity', uri: '​/activity', uriParams: [], service: '', type:'', method: 'post', resKey: 'ip' },

  { name: 'listIpsActivity', uri: '​/activity', uriParams: [], service: '', type:'', method: 'get', resKey: 'ips' },
]
