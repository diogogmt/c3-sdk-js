...
var resource = require('./v2/resource');
var security = require('./v2/security');

exports.all = _.union(iso, loadbalancer, offering, ip, ip, securityZone, server, snapshot, snapshotPolicy,
                      volume, template, token, vpc, vpn,resourcegroup, doc, job, resource, security);